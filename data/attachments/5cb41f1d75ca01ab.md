...
- Name: error-handling.spec.ts >> Tratamento de Erros >> Erros na geração por IA >> exibe mensagem de erro quando a API de IA retorna 401 (chave inválida)
- Location: tests/error-handling.spec.ts:104:9
...
- generic [ref=e1]:
  - main [ref=e2]:
    ...
    - generic [ref=e8]:
      ...
      - textbox "Sua API Key do OpenRouter (sk-or-v1-...)" [ref=e11]: chave-invalida
      - generic [ref=e12]:
        - 'textbox "Ex: Lançar um novo produto de software" [ref=e13]': Lançar um produto
